...
onMounted(async () => {
  try {
    ...
    propertyData.value = response.data; // Asignamos los datos de la propiedad
  } catch (error) {
...
<template>
  <div class="container">
    ...
    <div class="row">
      <!-- Iteramos sobre los inmuebles para mostrarlos en tarjetas -->
      <div v-for="property in propertyData" :key="property._id" class="col-md-4 mb-4">
